...
public class TriangleSquareCalcTest {
    @Test
    @DisplayName("Первая позитивная проверка")
    void positiveSquareCalcTest1() throws Exception {
        double result = TriangleSquareCalc.calculateTriangleSquare(2, 2, 2);
    ...
    void positiveSquareCalcTest2() throws Exception {
        double result = TriangleSquareCalc.calculateTriangleSquare(3, 4, 5);
    ...
    void positiveSquareCalcTest3() throws Exception {
        double result = TriangleSquareCalc.calculateTriangleSquare(5, 6, 7);
    ...
    void negativeSquareCalcTest1() {
        assertThatExceptionOfType(Exception.class).isThrownBy(() ->
                TriangleSquareCalc.calculateTriangleSquare(-2, 4, 5));
    }
    ...
    void negativeSquareCalcTest2() {
        assertThatExceptionOfType(Exception.class).isThrownBy(() ->
                TriangleSquareCalc.calculateTriangleSquare(0, 2, 2));
    }
    ...
    void negativeSquareCalcTest3() {
        assertThatExceptionOfType(Exception.class).isThrownBy(() ->
                TriangleSquareCalc.calculateTriangleSquare(1, 2, 3));
    }
}
